...
/* @@protoc_insertion_point(class_definition:base.Person) */ {
 ...
 public:
  ...
  public:
  [[nodiscard]] const ::base::Person_PhoneNumber& phones(int index) const;
  ::base::Person_PhoneNumber* PROTOBUF_NONNULL add_phones();
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber>& phones()
      const;
  // string name = 1;
  void clear_name() ;
...
/* @@protoc_insertion_point(class_definition:base.AddressBook) */ {
 ...
 public:
  ...
  public:
  [[nodiscard]] const ::base::Person& people(int index) const;
  ::base::Person* PROTOBUF_NONNULL add_people();
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::base::Person>& people()
      const;
