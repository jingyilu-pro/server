...
namespace google {
    namespace protobuf {
        template<>
        internal::EnumTraitsT<::base::Person_PhoneType_internal_data_>
        internal::EnumTraitsImpl::value<::base::Person_PhoneType>;
    } // namespace protobuf
} // namespace google
...
namespace base {
    ...
    class Person_PhoneNumber final : public ::google::protobuf::Message
            /* @@protoc_insertion_point(class_definition:base.Person.PhoneNumber) */ {
    public:
  ...
  ABSL_ATTRIBUTE_REINITIALIZES void Clear() PROTOBUF_FINAL;
    ...
    private:
        ...
        static ::absl::string_view FullMessageName() { return "base.Person.PhoneNumber"; }
  ...
  PROTOBUF_ALWAYS_INLINE void _internal_set_number(const ::std::string &value);
    ...
    public:
        ...
        ::base::Person_PhoneType type() const;

        void set_type(::base::Person_PhoneType value);

    private:
        ::base::Person_PhoneType _internal_type() const;

        void _internal_set_type(::base::Person_PhoneType value);

    public:
        // @@protoc_insertion_point(class_scope:base.Person.PhoneNumber)
    private:
        class _Internal;
    ...
    class Person final : public ::google::protobuf::Message
            /* @@protoc_insertion_point(class_definition:base.Person) */ {
    public:
  ...
  ABSL_ATTRIBUTE_REINITIALIZES void Clear() PROTOBUF_FINAL;
    ...
    private:
        ...
        static ::absl::string_view FullMessageName() { return "base.Person"; }
    ...
    public:
        ...
        ::base::Person_PhoneNumber * PROTOBUF_NONNULL mutable_phones(int index);

        ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> * PROTOBUF_NONNULL mutable_phones();

    private:
        const ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> &_internal_phones() const;

        ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> * PROTOBUF_NONNULL _internal_mutable_phones();

    public:
        const ::base::Person_PhoneNumber &phones(int index) const;

        ::base::Person_PhoneNumber * PROTOBUF_NONNULL add_phones();

        const ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> &phones() const;
  ...
  PROTOBUF_ALWAYS_INLINE void _internal_set_email(const ::std::string &value);
    ...
    public:
        // @@protoc_insertion_point(class_scope:base.Person)
    private:
        class _Internal;
        friend class ::google::protobuf::internal::TcParser;
        ...
        struct Impl_ {
            ...
            ::google::protobuf::internal::HasBits<1> _has_bits_;
            ::google::protobuf::internal::CachedSize _cached_size_;
            ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> phones_;
    ...
    class AddressBook final : public ::google::protobuf::Message
            /* @@protoc_insertion_point(class_definition:base.AddressBook) */ {
    public:
  ...
  ABSL_ATTRIBUTE_REINITIALIZES void Clear() PROTOBUF_FINAL;
    ...
    private:
        ...
        static ::absl::string_view FullMessageName() { return "base.AddressBook"; }
    ...
    public:
        ...
        ::base::Person * PROTOBUF_NONNULL mutable_people(int index);

        ::google::protobuf::RepeatedPtrField<::base::Person> * PROTOBUF_NONNULL mutable_people();

    private:
        const ::google::protobuf::RepeatedPtrField<::base::Person> &_internal_people() const;

        ::google::protobuf::RepeatedPtrField<::base::Person> * PROTOBUF_NONNULL _internal_mutable_people();

    public:
        const ::base::Person &people(int index) const;

        ::base::Person * PROTOBUF_NONNULL add_people();

        const ::google::protobuf::RepeatedPtrField<::base::Person> &people() const;

        // @@protoc_insertion_point(class_scope:base.AddressBook)
    private:
        class _Internal;
        friend class ::google::protobuf::internal::TcParser;
        ...
        struct Impl_ {
            ...
            ::google::protobuf::internal::HasBits<1> _has_bits_;
            ::google::protobuf::internal::CachedSize _cached_size_;
            ::google::protobuf::RepeatedPtrField<::base::Person> people_;
            PROTOBUF_TSAN_DECLARE_MEMBER
        };
...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
    ...
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_get:base.Person.PhoneNumber.number)
...
PROTOBUF_ALWAYS_INLINE void Person_PhoneNumber::set_number(Arg_ &&arg, Args_... args) {
        ...
        // @@protoc_insertion_point(field_set:base.Person.PhoneNumber.number)
    }
    ...
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        ...
        // @@protoc_insertion_point(field_mutable:base.Person.PhoneNumber.number)
        return _s;
    }
    ...
    inline ::std::string * PROTOBUF_NULLABLE Person_PhoneNumber::release_number() {
        ::google::protobuf::internal::TSanWrite(&_impl_);
        // @@protoc_insertion_point(field_release:base.Person.PhoneNumber.number)
    ...
    inline void Person_PhoneNumber::set_allocated_number(::std::string * PROTOBUF_NULLABLE value) {
        ...
        // @@protoc_insertion_point(field_set_allocated:base.Person.PhoneNumber.number)
    }
    ...
    inline ::base::Person_PhoneType Person_PhoneNumber::type() const {
        // @@protoc_insertion_point(field_get:base.Person.PhoneNumber.type)
        return _internal_type();
    }

    inline void Person_PhoneNumber::set_type(::base::Person_PhoneType value) {
        _internal_set_type(value);
        SetHasBit(_impl_._has_bits_[0], 0x00000002U);
        // @@protoc_insertion_point(field_set:base.Person.PhoneNumber.type)
    }

    inline ::base::Person_PhoneType Person_PhoneNumber::_internal_type() const {
        ::google::protobuf::internal::TSanRead(&_impl_);
        return static_cast<::base::Person_PhoneType>(_impl_.type_);
    }

    inline void Person_PhoneNumber::_internal_set_type(::base::Person_PhoneType value) {
        ::google::protobuf::internal::TSanWrite(&_impl_);
        _impl_.type_ = value;
    }
    ...
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_get:base.Person.name)
...
PROTOBUF_ALWAYS_INLINE void Person::set_name(Arg_ &&arg, Args_... args) {
        ...
        // @@protoc_insertion_point(field_set:base.Person.name)
    }
    ...
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        ...
        // @@protoc_insertion_point(field_mutable:base.Person.name)
        return _s;
    }
    ...
    inline ::std::string * PROTOBUF_NULLABLE Person::release_name() {
        ::google::protobuf::internal::TSanWrite(&_impl_);
        // @@protoc_insertion_point(field_release:base.Person.name)
    ...
    inline void Person::set_allocated_name(::std::string * PROTOBUF_NULLABLE value) {
        ...
        // @@protoc_insertion_point(field_set_allocated:base.Person.name)
    }
    ...
    inline ::int32_t Person::id() const {
        // @@protoc_insertion_point(field_get:base.Person.id)
        return _internal_id();
    }
    ...
    inline void Person::set_id(::int32_t value) {
        ...
        // @@protoc_insertion_point(field_set:base.Person.id)
    }
    ...
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_get:base.Person.email)
...
PROTOBUF_ALWAYS_INLINE void Person::set_email(Arg_ &&arg, Args_... args) {
        ...
        // @@protoc_insertion_point(field_set:base.Person.email)
    }
    ...
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        ...
        // @@protoc_insertion_point(field_mutable:base.Person.email)
        return _s;
    }
    ...
    inline ::std::string * PROTOBUF_NULLABLE Person::release_email() {
        ::google::protobuf::internal::TSanWrite(&_impl_);
        // @@protoc_insertion_point(field_release:base.Person.email)
    ...
    inline void Person::set_allocated_email(::std::string * PROTOBUF_NULLABLE value) {
        ...
        // @@protoc_insertion_point(field_set_allocated:base.Person.email)
    }
    ...
    inline ::base::Person_PhoneNumber * PROTOBUF_NONNULL Person::mutable_phones(int index)

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_mutable:base.Person.phones)
        return _internal_mutable_phones()->Mutable(index);
    }

    inline ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> * PROTOBUF_NONNULL Person::mutable_phones()

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
        // @@protoc_insertion_point(field_mutable_list:base.Person.phones)
        ::google::protobuf::internal::TSanWrite(&_impl_);
        return _internal_mutable_phones();
    }

    inline const ::base::Person_PhoneNumber &Person::phones(int index) const

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_get:base.Person.phones)
        return _internal_phones().Get(index);
    }

    inline ::base::Person_PhoneNumber * PROTOBUF_NONNULL Person::add_phones()

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        ::google::protobuf::internal::TSanWrite(&_impl_);
        ::base::Person_PhoneNumber *_add = _internal_mutable_phones()->Add();
        SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
        // @@protoc_insertion_point(field_add:base.Person.phones)
        return _add;
    }

    inline const ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> &Person::phones() const

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_list:base.Person.phones)
        return _internal_phones();
    }

    inline const ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> &
    Person::_internal_phones() const {
        ::google::protobuf::internal::TSanRead(&_impl_);
        return _impl_.phones_;
    }

    inline ::google::protobuf::RepeatedPtrField<::base::Person_PhoneNumber> *PROTOBUF_NONNULL
    ...
    inline ::base::Person * PROTOBUF_NONNULL AddressBook::mutable_people(int index)

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_mutable:base.AddressBook.people)
        return _internal_mutable_people()->Mutable(index);
    }

    inline ::google::protobuf::RepeatedPtrField<::base::Person> * PROTOBUF_NONNULL AddressBook::mutable_people()

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
        // @@protoc_insertion_point(field_mutable_list:base.AddressBook.people)
        ::google::protobuf::internal::TSanWrite(&_impl_);
        return _internal_mutable_people();
    }

    inline const ::base::Person &AddressBook::people(int index) const

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_get:base.AddressBook.people)
        return _internal_people().Get(index);
    }

    inline ::base::Person * PROTOBUF_NONNULL AddressBook::add_people()

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        ::google::protobuf::internal::TSanWrite(&_impl_);
        ::base::Person *_add = _internal_mutable_people()->Add();
        SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
        // @@protoc_insertion_point(field_add:base.AddressBook.people)
        return _add;
    }

    inline const ::google::protobuf::RepeatedPtrField<::base::Person> &AddressBook::people() const

    ABSL_ATTRIBUTE_LIFETIME_BOUND {
        // @@protoc_insertion_point(field_list:base.AddressBook.people)
        return _internal_people();
    }

    inline const ::google::protobuf::RepeatedPtrField<::base::Person> &
    AddressBook::_internal_people() const {
        ::google::protobuf::internal::TSanRead(&_impl_);
        return _impl_.people_;
    }

    inline ::google::protobuf::RepeatedPtrField<::base::Person> *PROTOBUF_NONNULL
...
namespace google {
    namespace protobuf {
        template<>
        struct is_proto_enum<::base::Person_PhoneType> : std::true_type {
        };

        template<>
        inline const EnumDescriptor * PROTOBUF_NONNULL GetEnumDescriptor<::base::Person_PhoneType>() {
            return ::base::Person_PhoneType_descriptor();
        }
    } // namespace protobuf
} // namespace google
